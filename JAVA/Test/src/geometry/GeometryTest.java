...
public class GeometryTest {
    ...
    private static void testSquareSymmetries() {
        RaialGraph sq1 = new RaialGraph(new Point("upper-right", 1, 1), new Point("upper-left", 0, 1),
                new Point("lower-left", 0, 0), new Point("lower-right", 1, 0));
        RaialGraph sq2 = sq1.rotateBy(30);
        RaialGraph sq3 = sq1.rotateBy(180);
        ...
        // method)
        List<RaialGraph> symmetries = squareSymmetries.symmetriesOf(sq1);
        for (RaialGraph s : symmetries) System.out.println(s);
    }
}